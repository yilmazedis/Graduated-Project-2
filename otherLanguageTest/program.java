...
public class program {
	...
	public static void fillList(){try{Scanner scanner=new Scanner(new File("outputs"));while(scanner.hasNextLine()){vlist.add(Integer.parseInt(scanner.nextLine()));}scanner.close();}catch(FileNotFoundException e){e.printStackTrace();}}
